...
import { formatCurrency, formatDate, formatDateTime, formatDateForDB, getEstadoColor, getProductoLabel } from '../utils/format';
import { PedidoConDetalles, Abono, EstadoPedido } from '../types';
        ...
        {pedidoActual.items && pedidoActual.items.length > 0 ? (
          pedidoActual.items.map((item, index) => (
            <View key={item.id} style={styles.productItem}>
              ...
              {index < pedidoActual.items.length - 1 && (
